defmodule Kanta.Gettext.MacrosTest do
  @moduledoc """
  Test from `gettext/test/gettext/macros_test.exs` modified to work with Kanta.Gettext and Kanta.Gettext.Macros.
  """
  ...
  require Kanta.Gettext.Macros, as: Macros

  @backend Kanta.Test.Backend
  ...
  test "pgettext/3, pngettext/4: dynamic context raises" do
    error =
      assert_raise ArgumentError, fn ->
        defmodule Sample do
          use Kanta.Gettext, backend: Gettext.MacrosTest.Translator
          context = "test"
