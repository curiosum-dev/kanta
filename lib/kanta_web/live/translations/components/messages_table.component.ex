                      ...
                      <%= for message <- @messages do %>
                        <tr>
                          ...
                          <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                            <a phx-click="navigate" phx-value-to={path(@socket, ~p"/kanta/locales/#{@locale.id}/translations/#{message.id}")} class="cursor-pointer text-indigo-600 hover:text-indigo-900">Edit</a>
                          </td>
                        </tr>
                      <% end %>
                    </tbody>
