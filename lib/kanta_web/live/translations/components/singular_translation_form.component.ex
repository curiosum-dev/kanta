    ...
    <div>
        ...
        <div>
              ...
              <ol class="flex items-center space-x-4">
                ...
                <li>
                  <div class="flex items-center">
                    ...
                    <.link patch={"/kanta/locales/#{@locale.id}/translations"} class="cursor-pointer ml-4 text-sm font-medium text-gray-400 hover:text-gray-200"><%= @locale.name %></.link>
                  </div>
                </li>
                <li>
                  <div class="flex items-center">
          ...
          <div class="mt-2 md:flex md:items-center md:justify-between">
            ...
            <div class="mt-4 flex-shrink-0 flex md:mt-0 md:ml-4">
              <button phx-click="save" phx-target={@myself} type="button" class="ml-3 inline-flex items-center px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-indigo-500 hover:bg-indigo-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-800 focus:ring-indigo-500">
                Save
              </button>
            </div>
          </div>
      ...
      <div class="mb-4">
        <div class="mt-4">
          ...
          <div class="mt-1">
            <input value={@translations.original_text} disabled type="text" name="original_text" id="original_text" class="bg-gray-50 shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md" placeholder="">
          </div>
        </div>
        <div class="mt-4">
          <label for="translated_text" class="block text-sm font-medium text-gray-700">Translated text</label>
          <div class="mt-1">
            <input phx-keyup="keyup" phx-target={@myself} value={@translations.translated_text} type="text" name="translated_text" id="translated_text" class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md" placeholder="">
          </div>
        </div>
      </div>
    </div>
