  ...
  @raw_locale_data %{
    ...
    "af-za" =>
      {"Afrikaans (South Africa)", "🇿🇦",
       ["#E03C31", "#FFFFFF", "#007749", "#000000", "#FFB81C", "#001489"]},
    # No ar-ar defined, stays nil
    "ar" => {"Arabic", nil, nil},
    "ar-ae" =>
      {"Arabic (United Arab Emirates)", "🇦🇪", ["#FF0000", "#00732F", "#FFFFFF", "#000000"]},
    "ar-sa" => {"Arabic (Saudi Arabia)", "🇸🇦", ["#006C35", "#FFFFFF"]},
    ...
    "be-by" => {"Belarusian (Belarus)", "🇧🇾", ["#CC0000", "#007A00", "#FFFFFF"]},
    # Inherited from bg-bg
    "bg" => {"Bulgarian", "🇧🇬", ["#FFFFFF", "#00966E", "#D62612"]},
    "bg-bg" => {"Bulgarian (Bulgaria)", "🇧🇬", ["#FFFFFF", "#00966E", "#D62612"]},
    # Inherited from bn-bd
    "bn" => {"Bengali", "🇧🇩", ["#006A4E", "#F42A41"]},
    "bn-bd" => {"Bengali (Bangladesh)", "🇧🇩", ["#006A4E", "#F42A41"]},
    ...
    "ca-es" => {"Catalan (Spain)", "🇪🇸", ["#AA151B", "#F1BF00"]},
    # Inherited from cs-cz
    "cs" => {"Czech", "🇨🇿", ["#FFFFFF", "#D7141A", "#11457E"]},
    "cs-cz" => {"Czech (Czech Republic)", "🇨🇿", ["#FFFFFF", "#D7141A", "#11457E"]},
    # Inherited from cy-gb
    "cy" => {"Welsh", "🇬🇧", ["#012169", "#FFFFFF", "#C8102E"]},
    "cy-gb" => {"Welsh (United Kingdom)", "🇬🇧", ["#012169", "#FFFFFF", "#C8102E"]},
    # Inherited from da-dk
    "da" => {"Danish", "🇩🇰", ["#C60C30", "#FFFFFF"]},
    "da-dk" => {"Danish (Denmark)", "🇩🇰", ["#C60C30", "#FFFFFF"]},
    # Inherited from de-de
    "de" => {"German", "🇩🇪", ["#000000", "#FF0000", "#FFCC00"]},
    "de-at" => {"German (Austria)", "🇦🇹", ["#ED2939", "#FFFFFF"]},
    "de-ch" => {"German (Switzerland)", "🇨🇭", ["#FF0000", "#FFFFFF"]},
    "de-de" => {"German (Germany)", "🇩🇪", ["#000000", "#FF0000", "#FFCC00"]},
    # Inherited from el-gr
    "el" => {"Greek", "🇬🇷", ["#0D5EAF", "#FFFFFF"]},
    "el-gr" => {"Greek (Greece)", "🇬🇷", ["#0D5EAF", "#FFFFFF"]},
    # No single default like en-en, stays nil
    "en" => {"English", nil, nil},
    "en-au" => {"English (Australia)", "🇦🇺", ["#00008B", "#FFFFFF", "#FF0000"]},
    "en-ca" => {"English (Canada)", "🇨🇦", ["#FF0000", "#FFFFFF"]},
    "en-gb" => {"English (United Kingdom)", "🇬🇧", ["#012169", "#FFFFFF", "#C8102E"]},
    "en-ie" => {"English (Ireland)", "🇮🇪", ["#009A49", "#FFFFFF", "#FF7900"]},
    "en-in" => {"English (India)", "🇮🇳", ["#FF9933", "#FFFFFF", "#138808", "#000080"]},
    "en-nz" => {"English (New Zealand)", "🇳🇿", ["#00247D", "#FFFFFF", "#CC142E"]},
    "en-us" => {"English (United States)", "🇺🇸", ["#B22234", "#FFFFFF", "#3C3B6E"]},
    "en-za" =>
    ...
    "es-ar" => {"Spanish (Argentina)", "🇦🇷", ["#74ACDF", "#FFFFFF", "#F6B40E"]},
    "es-cl" => {"Spanish (Chile)", "🇨🇱", ["#FFFFFF", "#0039A6", "#D52B1E"]},
    "es-co" => {"Spanish (Colombia)", "🇨🇴", ["#FCD116", "#003893", "#CE1126"]},
    "es-es" => {"Spanish (Spain)", "🇪🇸", ["#AA151B", "#F1BF00"]},
    "es-mx" => {"Spanish (Mexico)", "🇲🇽", ["#006847", "#FFFFFF", "#CE1126"]},
    "es-us" => {"Spanish (United States)", "🇺🇸", ["#B22234", "#FFFFFF", "#3C3B6E"]},
    # Special case, no change
    "es-419" => {"Spanish (Latin America and Caribbean)", nil, nil},
    # Inherited from et-ee
    "et" => {"Estonian", "🇪🇪", ["#0072CE", "#000000", "#FFFFFF"]},
    "et-ee" => {"Estonian (Estonia)", "🇪🇪", ["#0072CE", "#000000", "#FFFFFF"]},
    # Inherited from eu-es
    "eu" => {"Basque", "🇪🇸", ["#AA151B", "#F1BF00"]},
    "eu-es" => {"Basque (Spain)", "🇪🇸", ["#AA151B", "#F1BF00"]},
    # Inherited from fa-ir
    "fa" => {"Persian", "🇮🇷", ["#239F40", "#FFFFFF", "#DA0000"]},
    "fa-ir" => {"Persian (Iran)", "🇮🇷", ["#239F40", "#FFFFFF", "#DA0000"]},
    # Inherited from fi-fi
    "fi" => {"Finnish", "🇫🇮", ["#FFFFFF", "#003580"]},
    "fi-fi" => {"Finnish (Finland)", "🇫🇮", ["#FFFFFF", "#003580"]},
    # Inherited from fo-fo
    "fo" => {"Faroese", "🇫🇴", ["#FFFFFF", "#003897", "#ED2939"]},
    "fo-fo" => {"Faroese (Faroe Islands)", "🇫🇴", ["#FFFFFF", "#003897", "#ED2939"]},
    # Inherited from fr-fr
    "fr" => {"French", "🇫🇷", ["#002395", "#FFFFFF", "#ED2939"]},
    "fr-be" => {"French (Belgium)", "🇧🇪", ["#000000", "#FAE042", "#ED2939"]},
    "fr-ca" => {"French (Canada)", "🇨🇦", ["#FF0000", "#FFFFFF"]},
    "fr-ch" => {"French (Switzerland)", "🇨🇭", ["#FF0000", "#FFFFFF"]},
    "fr-fr" => {"French (France)", "🇫🇷", ["#002395", "#FFFFFF", "#ED2939"]},
    # Inherited from ga-ie
    "ga" => {"Irish", "🇮🇪", ["#009A49", "#FFFFFF", "#FF7900"]},
    "ga-ie" => {"Irish (Ireland)", "🇮🇪", ["#009A49", "#FFFFFF", "#FF7900"]},
    # Inherited from gl-es
    "gl" => {"Galician", "🇪🇸", ["#AA151B", "#F1BF00"]},
    "gl-es" => {"Galician (Spain)", "🇪🇸", ["#AA151B", "#F1BF00"]},
    # Inherited from he-il
    "he" => {"Hebrew", "🇮🇱", ["#FFFFFF", "#0038B8"]},
    "he-il" => {"Hebrew (Israel)", "🇮🇱", ["#FFFFFF", "#0038B8"]},
    # Inherited from hi-in
    "hi" => {"Hindi", "🇮🇳", ["#FF9933", "#FFFFFF", "#138808", "#000080"]},
    "hi-in" => {"Hindi (India)", "🇮🇳", ["#FF9933", "#FFFFFF", "#138808", "#000080"]},
    # Inherited from hr-hr
    "hr" => {"Croatian", "🇭🇷", ["#FF0000", "#FFFFFF", "#0000FF"]},
    "hr-hr" => {"Croatian (Croatia)", "🇭🇷", ["#FF0000", "#FFFFFF", "#0000FF"]},
    # Inherited from hu-hu
    "hu" => {"Hungarian", "🇭🇺", ["#CE2939", "#FFFFFF", "#477050"]},
    "hu-hu" => {"Hungarian (Hungary)", "🇭🇺", ["#CE2939", "#FFFFFF", "#477050"]},
    # Inherited from hy-am
    "hy" => {"Armenian", "🇦🇲", ["#D90012", "#0033A0", "#F2A800"]},
    "hy-am" => {"Armenian (Armenia)", "🇦🇲", ["#D90012", "#0033A0", "#F2A800"]},
    # Inherited from id-id
    "id" => {"Indonesian", "🇮🇩", ["#FF0000", "#FFFFFF"]},
    "id-id" => {"Indonesian (Indonesia)", "🇮🇩", ["#FF0000", "#FFFFFF"]},
    # Inherited from is-is
    "is" => {"Icelandic", "🇮🇸", ["#02529C", "#FFFFFF", "#DC1E35"]},
    "is-is" => {"Icelandic (Iceland)", "🇮🇸", ["#02529C", "#FFFFFF", "#DC1E35"]},
    # Inherited from it-it
    "it" => {"Italian", "🇮🇹", ["#009246", "#FFFFFF", "#CE2B37"]},
    "it-ch" => {"Italian (Switzerland)", "🇨🇭", ["#FF0000", "#FFFFFF"]},
    "it-it" => {"Italian (Italy)", "🇮🇹", ["#009246", "#FFFFFF", "#CE2B37"]},
    # Inherited from ja-jp
    "ja" => {"Japanese", "🇯🇵", ["#FFFFFF", "#BC002D"]},
    "ja-jp" => {"Japanese (Japan)", "🇯🇵", ["#FFFFFF", "#BC002D"]},
    # Inherited from ka-ge
    "ka" => {"Georgian", "🇬🇪", ["#FFFFFF", "#FF0000"]},
    "ka-ge" => {"Georgian (Georgia)", "🇬🇪", ["#FFFFFF", "#FF0000"]},
    # Inherited from kk-kz
    "kk" => {"Kazakh", "🇰🇿", ["#00AFCA", "#FDE700"]},
    "kk-kz" => {"Kazakh (Kazakhstan)", "🇰🇿", ["#00AFCA", "#FDE700"]},
    # Inherited from ko-kr
    "ko" => {"Korean", "🇰🇷", ["#FFFFFF", "#CD2E3A", "#0047A0", "#000000"]},
    "ko-kr" => {"Korean (South Korea)", "🇰🇷", ["#FFFFFF", "#CD2E3A", "#0047A0", "#000000"]},
    "la" => {"Latin", nil, nil},
    # Inherited from lt-lt
    "lt" => {"Lithuanian", "🇱🇹", ["#FDB913", "#006A44", "#C1272D"]},
    "lt-lt" => {"Lithuanian (Lithuania)", "🇱🇹", ["#FDB913", "#006A44", "#C1272D"]},
    # Inherited from lv-lv
    "lv" => {"Latvian", "🇱🇻", ["#9E3039", "#FFFFFF"]},
    "lv-lv" => {"Latvian (Latvia)", "🇱🇻", ["#9E3039", "#FFFFFF"]},
    # Inherited from mk-mk
    "mk" => {"Macedonian", "🇲🇰", ["#D20000", "#FFE600"]},
    "mk-mk" => {"Macedonian (North Macedonia)", "🇲🇰", ["#D20000", "#FFE600"]},
    # Inherited from mn-mn
    "mn" => {"Mongolian", "🇲🇳", ["#C40000", "#0066B3", "#FFD500"]},
    "mn-mn" => {"Mongolian (Mongolia)", "🇲🇳", ["#C40000", "#0066B3", "#FFD500"]},
    ...
    "mt-mt" => {"Maltese (Malta)", "🇲🇹", ["#FFFFFF", "#CC292C"]},
    ...
    "nl-be" => {"Dutch (Belgium)", "🇧🇪", ["#000000", "#FAE042", "#ED2939"]},
    "nl-nl" => {"Dutch (Netherlands)", "🇳🇱", ["#AE1C28", "#FFFFFF", "#21468B"]},
    ...
    "pl-pl" => {"Polish (Poland)", "🇵🇱", ["#FFFFFF", "#DC143C"]},
    # Inherited from pt-pt
    "pt" => {"Portuguese", "", ["#046A38", "#DA291C", "#FFE900", "#002D73"]},
    "pt-br" => {"Portuguese (Brazil)", "🇧🇷", ["#009B3A", "#FFCC29", "#002776"]},
    "pt-pt" => {"Portuguese (Portugal)", "🇵🇹", ["#046A38", "#DA291C", "#FFE900", "#002D73"]},
    # Inherited from ro-ro
    "ro" => {"Romanian", "🇷🇴", ["#002B7F", "#FCD116", "#CE1126"]},
    "ro-ro" => {"Romanian (Romania)", "🇷🇴", ["#002B7F", "#FCD116", "#CE1126"]},
    # Inherited from ru-ru
    "ru" => {"Russian", "🇷🇺", ["#FFFFFF", "#0039A6", "#D52B1E"]},
    "ru-ru" => {"Russian (Russia)", "🇷🇺", ["#FFFFFF", "#0039A6", "#D52B1E"]},
    "ru-ua" => {"Russian (Ukraine)", "🇺🇦", ["#005BBB", "#FFD500"]},
    # Inherited from sk-sk
    "sk" => {"Slovak", "🇸🇰", ["#FFFFFF", "#0B4EA2", "#EE1C25"]},
    "sk-sk" => {"Slovak (Slovakia)", "🇸🇰", ["#FFFFFF", "#0B4EA2", "#EE1C25"]},
    # Inherited from sl-si
    "sl" => {"Slovenian", "🇸🇮", ["#FFFFFF", "#0000FF", "#FF0000"]},
    "sl-si" => {"Slovenian (Slovenia)", "🇸🇮", ["#FFFFFF", "#0000FF", "#FF0000"]},
    # Inherited from sq-al
    "sq" => {"Albanian", "🇦🇱", ["#FF0000", "#000000"]},
    "sq-al" => {"Albanian (Albania)", "🇦🇱", ["#FF0000", "#000000"]},
    # Inherited from sr-rs
    "sr" => {"Serbian", "🇷🇸", ["#C6363C", "#0C4076", "#FFFFFF"]},
    "sr-rs" => {"Serbian (Serbia)", "🇷🇸", ["#C6363C", "#0C4076", "#FFFFFF"]},
    # Inherited from sv-se
    "sv" => {"Swedish", "🇸🇪", ["#006AA7", "#FFCD00"]},
    "sv-fi" => {"Swedish (Finland)", "🇫🇮", ["#FFFFFF", "#003580"]},
    "sv-se" => {"Swedish (Sweden)", "🇸🇪", ["#006AA7", "#FFCD00"]},
    # Inherited from sw-ke
    "sw" => {"Swahili", "🇰🇪", ["#000000", "#BB0000", "#008800", "#FFFFFF"]},
    "sw-ke" => {"Swahili (Kenya)", "🇰🇪", ["#000000", "#BB0000", "#008800", "#FFFFFF"]},
    # Inherited from ta-in
    "ta" => {"Tamil", "🇮🇳", ["#FF9933", "#FFFFFF", "#138808", "#000080"]},
    "ta-in" => {"Tamil (India)", "🇮🇳", ["#FF9933", "#FFFFFF", "#138808", "#000080"]},
    # Inherited from th-th
    "th" => {"Thai", "🇹🇭", ["#A51931", "#FFFFFF", "#2E2A4D"]},
    "th-th" => {"Thai (Thailand)", "🇹🇭", ["#A51931", "#FFFFFF", "#2E2A4D"]},
    # Inherited from tr-tr
    "tr" => {"Turkish", "🇹🇷", ["#E30A17", "#FFFFFF"]},
    "tr-tr" => {"Turkish (Turkey)", "🇹🇷", ["#E30A17", "#FFFFFF"]},
    # Inherited from uk-ua
    "uk" => {"Ukrainian", "🇺🇦", ["#005BBB", "#FFD500"]},
    "uk-ua" => {"Ukrainian (Ukraine)", "🇺🇦", ["#005BBB", "#FFD500"]},
    # Inherited from ur-pk
    "ur" => {"Urdu", "🇵🇰", ["#006633", "#FFFFFF"]},
    "ur-pk" => {"Urdu (Pakistan)", "🇵🇰", ["#006633", "#FFFFFF"]},
    # Inherited from uz-uz
    "uz" => {"Uzbek", "🇺🇿", ["#0072CE", "#FFFFFF", "#009A44", "#CE1126"]},
    "uz-uz" => {"Uzbek (Uzbekistan)", "🇺🇿", ["#0072CE", "#FFFFFF", "#009A44", "#CE1126"]},
    # Inherited from vi-vn
    "vi" => {"Vietnamese", "🇻🇳", ["#DA251D", "#FFFF00"]},
    "vi-vn" => {"Vietnamese (Vietnam)", "🇻🇳", ["#DA251D", "#FFFF00"]},
    # No single default like zh-zh, stays nil
    "zh" => {"Chinese", nil, nil},
    "zh-cn" => {"Simplified Chinese (China)", "🇨🇳", ["#EE1C25", "#FFFF00"]},
    "zh-hk" => {"Traditional Chinese (Hong Kong)", "🇭🇰", ["#DE2910", "#FFFFFF"]},
    "zh-sg" => {"Simplified Chinese (Singapore)", "🇸🇬", ["#ED2939", "#FFFFFF"]},
    "zh-tw" => {"Traditional Chinese (Taiwan)", "🇹🇼", ["#FE0000", "#000095", "#FFFFFF"]}
  }
