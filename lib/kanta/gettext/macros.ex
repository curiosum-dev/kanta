defmodule Kanta.Gettext.Macros do
  @moduledoc """
  Modified Gettext's v0.26.2 Gettext.Macros module.

  Functions modified to use Kanta.Gettext.Adapter:
  - `&singular_extract_and_translate/6`
  - `&plural_extract_and_translate/8`
  ...
  *Available since v0.26.0.*
  ...
  defp singular_extract_and_translate(env, backend, domain, msgctxt, msgid, bindings) do
    ...
    quote do
      case Adapter.get_singular_translation(
             unquote(backend),
             unquote(domain),
             unquote(msgctxt),
             unquote(msgid)
  ...
  defp plural_extract_and_translate(
    ...
    quote do
      case Adapter.get_plural_translation(
             unquote(backend),
             unquote(domain),
             unquote(msgctxt),
             unquote(msgid),
